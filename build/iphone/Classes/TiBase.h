...
// in simulator we redefine to format for cohistoria Developer console
...
{\
	NSString * exceptionName = [@"org.cohistoria." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.cohistoria";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIcohistoriaNativeItemNone = -1, 
	UIcohistoriaNativeItemSpinner = -2,
	UIcohistoriaNativeItemProgressBar = -3,
	
	UIcohistoriaNativeItemSlider = -4,
	UIcohistoriaNativeItemSwitch = -5,
	UIcohistoriaNativeItemMultiButton = -6,
	UIcohistoriaNativeItemSegmented = -7,
	
	UIcohistoriaNativeItemTextView = -8,
	UIcohistoriaNativeItemTextField = -9,
	UIcohistoriaNativeItemSearchBar = -10,
	
	UIcohistoriaNativeItemPicker = -11,
	UIcohistoriaNativeItemDatePicker = -12,
	
	UIcohistoriaNativeItemInfoLight = -13,
	UIcohistoriaNativeItemInfoDark = -14,
	
	UIcohistoriaNativeItemDisclosure = -15,
	
	UIcohistoriaNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all cohistoria instances of
