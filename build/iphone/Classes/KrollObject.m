...
//@interface cohistoriaObject : NSObject
//@end

@interface cohistoriaObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[cohistoriaObject class]])
		{
			for (NSString *key in [[(cohistoriaObject*)o modules] allKeys])
			{
