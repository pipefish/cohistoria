...
@interface cohistoriaObject : KrollCoverageObject {
#else
@interface cohistoriaObject : KrollObject {
#endif
@private
...
extern NSString * cohistoria$ModuleRequireFormat;
