...
/**
 Base class for all cohistoria views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the cohistoria view hierarchy (such as wrapped iOS UIViews) was touched.
